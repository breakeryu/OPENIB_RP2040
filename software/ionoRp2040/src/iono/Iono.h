...
#define AO1 20
  ...
  #define IONO_PIN_DO1 10
  #define IONO_PIN_DO2 11
  #define IONO_PIN_DO3 12
  #define IONO_PIN_DO4 13
  ...
  #define IONO_PIN_DI5 23
  #define IONO_PIN_DI6 24
...
#define IONO_BLE    SERIAL_PORT_MONITOR
